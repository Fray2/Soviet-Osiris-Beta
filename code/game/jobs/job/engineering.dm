/datum/job/chief_engineer
	...
	Техника всей станции ​​- ваша ответственность. Не позволяйте посторонним вмешиваться или вторгаться в ваш домен - даже сотрудники командования не являются исключением.<br>\
	Относитесь к каждому члену гильдии как к своей семье. Держите их при деньгах, накормленными и в безопасности.<br>\
	Не забывайте так же и том, что на плечах гильдии лежит происзводство всего низкотехнологичного и среднетехнологичного оборудования, так как основные производственные мощности расположены именно у вас."

	duties = "Управляй адептами гильдии - ставьте задачи и распределите их по разным отделам.<br>\
	Стремитесь защищать права ваших адептов, а также их безопасность и здоровье.<br>\
	Проводите собственные ремонтные работы и проекты по мере необходимости."
...
Не позволяйте посторонним, даже командному штабу, вмешиваться в обязанности гильдии. И помните - будьте готовы отвечать на экстренные запросы в любое время."
	...
	duties = "Запустите суперматерию.<br>\
	Чините всё и вся, что выглядит поврежденым.<br>\
	Отвечайте на запросы о брешах в стене.<br>\
	Держите все части колонии в тепле, с воздухом, и с энергией.<br>\
	Обеспечивайте колонию всем необходимым в плане расходных товаров и инструментов, если конечно, это что то вы производите."
